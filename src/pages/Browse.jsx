...
import { Heart, User, MessageCircle, Sparkles, Search, LogOut, Filter } from 'lucide-react';
        ...
        <div className="max-w-md mx-auto text-center">
          <div className="bg-white rounded-3xl shadow-xl p-8">
            <div className="w-20 h-20 bg-gradient-to-r from-[#C46A4A]/10 to-[#D4A853]/10 rounded-full flex items-center justify-center mx-auto mb-6">
              <Filter className="w-10 h-10 text-[#C46A4A]" />
            </div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">Browse Coming Soon</h2>
            <p className="text-gray-600 mb-6">
              Advanced search and filtering will be available in the next update.
              You'll be able to browse profiles with custom filters.
            </p>
            <Link to={createPageUrl('Dashboard')}>
