  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <p className="mt-8 text-center text-sm text-gray-500">
        ...
        <Link to={createPageUrl('TermsOfService')} className="text-[#C46A4A] hover:underline">Terms of Service</Link>
        {' '}and{' '}
      ...
      <p className="mt-4 text-center text-gray-600">
        ...
        <Link to="/login" className="text-[#C46A4A] hover:underline font-medium">
          Sign In
        </Link>
      </p>
    </div>
